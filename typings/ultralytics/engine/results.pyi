...
class Results(SimpleClass):
    ...
    """
    def __init__(self, orig_img, path, names, boxes=..., masks=..., probs=..., keypoints=..., obb=..., speed=...) -> None:
        """
    ...
    def update(self, boxes=..., masks=..., probs=..., obb=..., keypoints=...): # -> None:
        """
    ...
    def plot(self, conf=..., line_width=..., font_size=..., font=..., pil=..., img=..., im_gpu=..., kpt_radius=..., kpt_line=..., labels=..., boxes=..., masks=..., probs=..., show=..., save=..., filename=..., color_mode=...):
        """
    ...
    def save(self, filename=..., *args, **kwargs): # -> str:
        """
    ...
    def verbose(self): # -> LiteralString | str:
        """
    ...
    def save_txt(self, txt_file, save_conf=...): # -> None:
        """
    ...
    def summary(self, normalize=..., decimals=...): # -> list[Any]:
        """
    ...
    def to_csv(self, normalize=..., decimals=..., *args, **kwargs):
        """
    ...
    def to_xml(self, normalize=..., decimals=..., *args, **kwargs): # -> LiteralString:
        """
    ...
    def to_sql(self, table_name=..., normalize=..., decimals=..., db_path=...): # -> None:
        """
...
class Boxes(BaseTensor):
    ...
    @property
    def xyxy(self): # -> Tensor | ndarray[Any, Any]:
        """
    ...
    @property
    def conf(self): # -> Tensor | ndarray[Any, Any]:
        """
    ...
    @property
    def cls(self): # -> Tensor | ndarray[Any, Any]:
        """
    ...
    @property
    def id(self): # -> Tensor | ndarray[Any, Any] | None:
        """
    ...
    @property
    @lru_cache(maxsize=2)
    def xywh(self): # -> Tensor | NDArray[floating[_32Bit]]:
        """
    ...
    @property
    @lru_cache(maxsize=2)
    def xyxyn(self): # -> Tensor | NDArray[Any]:
        """
    ...
    @property
    @lru_cache(maxsize=2)
    def xywhn(self): # -> Tensor | NDArray[floating[_32Bit]]:
        """
...
class Keypoints(BaseTensor):
    ...
    @property
    @lru_cache(maxsize=1)
    def xy(self): # -> Tensor | ndarray[Any, Any]:
        """
    ...
    @property
    @lru_cache(maxsize=1)
    def xyn(self): # -> Tensor | NDArray[Any]:
        """
    ...
    @property
    @lru_cache(maxsize=1)
    def conf(self): # -> Tensor | ndarray[Any, Any] | None:
        """
...
class Probs(BaseTensor):
    ...
    @property
    @lru_cache(maxsize=1)
    def top5conf(self): # -> Tensor | ndarray[Any, Any]:
        """
...
class OBB(BaseTensor):
    ...
    @property
    def xywhr(self): # -> Tensor | ndarray[Any, Any]:
        """
    ...
    @property
    @lru_cache(maxsize=2)
    def xyxyxyxy(self): # -> NDArray[Any] | Tensor:
        """
    ...
    @property
    @lru_cache(maxsize=2)
    def xyxyxyxyn(self): # -> Tensor | NDArray[Any]:
        """
    ...
    @property
    @lru_cache(maxsize=2)
    def xyxy(self): # -> Tensor | NDArray[Any]:
        """
